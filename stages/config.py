...
class PipelineConfig:
    ...
    failures_prefix: str
    run_date: str
    # Defaulted so existing callers/tests that don't set them stay valid.
    predictions_prefix: str = "predictions"
    drift_prefix: str = "drift"
...
def load_config(config_path: str, run_date: str | None = None) -> PipelineConfig:
    ...
    return PipelineConfig(
        ...
        drift_prefix=raw.get("drift_prefix", "drift"),
    )
